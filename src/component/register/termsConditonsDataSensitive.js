...
import {STR_BACK, STR_TITLE_TERMS_DATA_SENSITIVE_DETAILS} from "../../utils/constantstring";
import LoadingIndicator from '../styles/loadingIndicator'
function TermsCondtionsDataSensitive(props){
    ...
    //View Parent
        return (
            <View style={styles.container}>
                ...
                <Text style = {[stylesCommon.titleQuestionStyle, {marginTop:"15%"} ]}>{STR_TITLE_TERMS_DATA_SENSITIVE_DETAILS}</Text>
...
export default TermsCondtionsDataSensitive
