...
import { STR_ERROR, STR_ANNONCE_TRYING, STR_QUESTION_GENDER_PARTNER, STR_BACK, STR_CONTINUE, STR_MAN, STR_WOMAN} from "../../utils/constantstring";
import { useState, useRef } from 'react';
import {ColorCustom} from "../../utils/color"
import {ErrorRegisterScreen} from "../../utils/constantstring";
function GenderPartner(props){
    ...
    //View Parent
        return (
            ...
            <View style={styles.container}>
                 <Text style = {stylesCommon.titleQuestionStyle}>{STR_QUESTION_GENDER_PARTNER}</Text>
